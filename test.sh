...
$RUNNER -m mosfit -e mosfit/tests/LSQ12dlf.json --test -i 2 --no-fracking -m kilonova --variance-for-each band --offline -w products/walkers.json -F mejecta_blue 0.01 vejecta_blue 100000.0 --extra-times 56000 --prefer-fluxes
if [ "$1" = -c ]; then

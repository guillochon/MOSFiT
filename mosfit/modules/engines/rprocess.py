...
class RProcess(Engine):
    ...
    def process(self, **kwargs):
        ...
        barnes_M = np.asarray([1.e-3, 1.e-3, 1.e-3, 5.e-3, 5.e-3,
                               5.e-3, 1.e-2, 1.e-2, 1.e-2, 5.e-2, 5.e-2,
                               5.e-2, ])
        barnes_v = np.asarray(
            [0.1, 0.2, 0.3, 0.1, 0.2, 0.3, 0.1, 0.2, 0.3, 0.1, 0.2, 0.3])
        barnes_a = np.asarray(
            [2.01, 4.52, 8.16, 0.81, 1.9, 3.2, 0.56, 1.31, 2.19, .27, .55,
             .95])
        barnes_b = np.asarray(
            [0.28, 0.62, 1.19, 0.19, 0.28, 0.45, 0.17, 0.21, 0.31, 0.10, 0.13,
             0.15])
        barnes_d = np.asarray(
            [1.12, 1.39, 1.52, 0.86, 1.21, 1.39, 0.74, 1.13, 1.32, 0.6, 0.9,
             1.13])
